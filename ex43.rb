...
class CentralCorridor < Scene
	def enter()
		...
		if action == "shoot!"
			...
			puts "off you aim. Your laser hits his costume his mother bought him, which"
			puts "makes him fly into an insane rage and blast you repeatly in the face until"
			...
			puts "bang your heat on the metal wall and pass out"
			puts "You wake up shortly after only to die as the Gothon stomps on"
			puts "your head and eats you."
			return 'death'

		elsif action == "tell a joke"
			puts "Lucky for you they made you learn Githon insults in the academy."
			puts "You tell the one Gothon joke you know:"
			puts "Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf ne bhaq gur ubhfr."
...
class LaserWeaponArmoury < Scene
	...
	def enter()
		puts "You do a dice roll into the Weapon Armoury, crouch and scan the room"
		...
		if guess == code
			puts "The container clicks ipen and the seal breaks, letting gas out."
